...
qb_fp <- readHTMLTable(getURL("https://www.fantasypros.com/nfl/projections/qb.php"), stringsAsFactors = FALSE)$data
rb_fp <- readHTMLTable(getURL("https://www.fantasypros.com/nfl/projections/rb.php"), stringsAsFactors = FALSE)$data
wr_fp <- readHTMLTable(getURL("https://www.fantasypros.com/nfl/projections/wr.php"), stringsAsFactors = FALSE)$data
te_fp <- readHTMLTable(getURL("https://www.fantasypros.com/nfl/projections/te.php"), stringsAsFactors = FALSE)$data
k_fp <- readHTMLTable(getURL("https://www.fantasypros.com/nfl/projections/k.php"), stringsAsFactors = FALSE)$data
